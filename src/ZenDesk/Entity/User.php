...
class User extends AbstractEntity implements RestParametersAware
{
    ...
    /** @var bool */
    protected $emailMarkedAsPrimary = true;
    ...
    /**
     * @param $email
     * @param bool $emailMarkedAsPrimary
     */
    public function setEmail($email, $emailMarkedAsPrimary = true)
    {
        $this->email = $email;
        $this->emailMarkedAsPrimary = $emailMarkedAsPrimary;
    }

    /**
     * @return boolean
     */
    public function isEmailMarkedAsPrimary()
    {
        return $this->emailMarkedAsPrimary;
    }
